...
{{ __( 'admin.postAdmin' ) }}: {{ __( 'admin.new' ) }}

@stop

@section('contents')

<h1>{{ __( 'admin.postAdmin' ) }} - {{ __( 'admin.new' ) }}</h1>

@include('layouts.error')

<form class="form-horizontal" role="form" method="POST" action="/admin/posts/store" data-editor="true">
	...
	<div class="col-md-5 col-md-offset-1">
		...
		<div class="form-group">
			...
			<select id="language" name="language" class="form-control" required>
				<option value="nl">{{ __( 'admin.langNL' ) }}</option>
				<option value="en">{{ __( 'admin.langEN' ) }}</option>
			</select>
		</div>
